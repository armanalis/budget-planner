...
const dictionary = {
  en: {
    ...
    clearHouseholdDataTitle: "Remove all household data",
    clearHouseholdDataDescription:
      "Permanently deletes all expenses, chat messages, budgets, sub-category budgets, and recurring templates for this household. Members, the household name, and accounts stay. Only owners can do this.",
    clearHouseholdDataConfirmLabel: "Confirmation",
    clearHouseholdDataConfirmPlaceholder: "CLEAR ALL",
    clearHouseholdDataConfirmHint: "Type CLEAR ALL to confirm.",
    clearHouseholdDataButton: "Remove all data",
    clearHouseholdDataBusy: "Removing…",
    clearHouseholdDataSuccess: "All household data was removed.",
    clearHouseholdDataFailed: "Could not remove data.",
  ...
  tr: {
    ...
    clearHouseholdDataTitle: "Tüm ev verilerini kaldır",
    clearHouseholdDataDescription:
      "Bu ev için tüm giderleri, sohbet mesajlarını, bütçeleri, alt kategori limitlerini ve düzenli harcama şablonlarını kalıcı olarak siler. Üyeler, ev adı ve hesaplar kalır. Yalnızca sahipler yapabilir.",
    clearHouseholdDataConfirmLabel: "Onay",
    clearHouseholdDataConfirmPlaceholder: "CLEAR ALL",
    clearHouseholdDataConfirmHint: "Onaylamak için CLEAR ALL yazın.",
    clearHouseholdDataButton: "Tüm verileri kaldır",
    clearHouseholdDataBusy: "Kaldırılıyor…",
    clearHouseholdDataSuccess: "Tüm ev verileri silindi.",
    clearHouseholdDataFailed: "Veriler kaldırılamadı.",
  ...
  it: {
    ...
    clearHouseholdDataTitle: "Rimuovi tutti i dati della casa",
    clearHouseholdDataDescription:
      "Elimina definitivamente tutte le spese, i messaggi della chat, i budget, i limiti per sottocategoria e i template ricorrenti di questa casa. Membri, nome della casa e account restano. Solo i proprietari possono farlo.",
    clearHouseholdDataConfirmLabel: "Conferma",
    clearHouseholdDataConfirmPlaceholder: "CLEAR ALL",
    clearHouseholdDataConfirmHint: "Scrivi CLEAR ALL per confermare.",
    clearHouseholdDataButton: "Rimuovi tutti i dati",
    clearHouseholdDataBusy: "Rimozione…",
    clearHouseholdDataSuccess: "Tutti i dati della casa sono stati rimossi.",
    clearHouseholdDataFailed: "Impossibile rimuovere i dati.",
